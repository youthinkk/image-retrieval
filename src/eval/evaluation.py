...
def eval_color():
    test_dict = get_index(TEST_COLOR_INDEX_PATH)
    train_dict = get_index(TRAIN_COLOR_INDEX_PATH)
...
def eval_sift():
    test_dict = get_index(TEST_SIFT_INDEX_PATH)
